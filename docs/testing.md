...
6. **fix4** — Collection pills = All + 6 games; the active game stays
...
11. **fix5** — Search pills highlight the active game; all enum games are
    offered as filters.
12. **fix8** — Local search results appear immediately (< 3 s), Lorcana cards
